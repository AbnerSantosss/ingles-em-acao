/**
 * O estado que as Server Actions de `/admin/configuracoes` devolvem para os
 * formulários.
 *
 * ⚠️ Fica num arquivo **sem** `'use server'` e **sem** Prisma de propósito: ele
 * é importado dos dois lados — pelo componente cliente (`useActionState`) e
 * pela action — e um `'use server'` só pode exportar função assíncrona,
 * enquanto um import de servidor arrastaria o Prisma para o bundle do
 * navegador.
 */
