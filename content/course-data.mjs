...

  {
    ...
    pages: [
      ...
      { blocks: [
        ...
        { t: "mc", id: "a6mc1", title: "ESCOLHA A FRASE CORRETA", v: "gray", questions: [
      ...
      { blocks: [
        ...
        { t: "match", id: "a6match1", title: "LIGUE PAÍS E NACIONALIDADE (AULA 06)",
  ...
  ,{
    ...
    pages: [
      ...
      { blocks: [
        ...
        { t: "match", id: "a7match1", title: "LIGUE O PARENTE (AULA 07)",
          left: ["mother", "brother", "daughter", "grandfather", "wife", "parents"],
          right: ["avô", "esposa", "filha", "irmão", "mãe", "pais"],
          answer: [4, 3, 2, 0, 1, 5] },
        { t: "mc", id: "a7mc1", title: "ESCOLHA A OPÇÃO CORRETA", v: "gray", questions: [
